...
class KMeansClustering:
    ...
    def elbow_plot(self, data):
        """
                ...
                Output: A picture saved to directory
        ...
        try:
            ...
            self.logger_object.log(self.file_object,'The optimum number of cluster is: '+str(self.kn.knee)+'. Exited the elboe_pot methof of the KmeanClustering class')
            return self.kn.knee
        except Exception as e:
            self.logger_object.log(self.file_object,'Exception occuered in elbow_plot method of the KMeansClustering class. Exception message: '+str(e))
