...
class DBOperation:
    ...
    def __init__(self):
        self.badFilePath = "Prediction_Raw_Data_Files_Validated/Bad_Data"
        self.goodFilePath = "Prediction_Raw_Data_Files_Validated/Good_Data"
        self.logger = App_Logger()


    def createDatabaseForPrediction(self, DatabaseName):
        """
    ...
    def createTableDB(self, TableName, column_names):
        ...
        try:
            ...
            file = open("Prediction_Logs/DbTableCreationLog.txt",'a+')
